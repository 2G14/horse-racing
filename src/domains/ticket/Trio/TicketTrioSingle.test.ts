import TicketTrioSingle from '@/domains/ticket/Trio/TicketTrioSingle.ts';
...
Deno.test('create: 馬番を昇順で与えた時、昇順で生成される', () => {
  ...
  const ticketResult = TicketTrioSingle.create(
    horseNumber1,
    horseNumber2,
    horseNumber3,
  );
...
Deno.test('create: 馬番を非昇順で与えた時、昇順で生成される', () => {
  ...
  assert(ticket.horseNumber2.equals(horseNumber3));
  assert(ticket.horseNumber3.equals(horseNumber1));
});
...
Deno.test('equals: 全ての馬番が同じ時、同じ馬券の判定になる', () => {
  ...
  const ticket1 = unsafe(TicketTrioSingle.create(
    horseNumber1,
    horseNumber2,
    horseNumber3,
  ));
  const ticket2 = unsafe(TicketTrioSingle.create(
    horseNumber1,
    horseNumber2,
    horseNumber3,
  ));
